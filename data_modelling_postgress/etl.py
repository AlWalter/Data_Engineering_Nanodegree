...
def process_song_file(cur, filepath):
    """
    Process the .json file to create the songs- and artist entries in the database.

    Parametesr:
    - cur: cursor object to execute SQL-commands.
    - filepath (string): path to the song_data .json file.
...
def process_log_file(cur, filepath):
    """
    Process the .json file to create the time-, user- and songplay entries in the database.
    
    Parameters:
    - cur: cursor object to execute SQL-commands.
    - filepath (string) : path to a log_data .json file
...
def main():
    """
    Build ETL pipeline that transfers data from files in two local directories into the database:

    Create connection to the Postgres database,
    get a cursor object to process SQL-queries,
